...
{other_assistants}
------
Based on the preliminary response below, which requirements can be fulfilled by each assistant?
...
If you are unable to fully answer, or if no prompts are addressed to you, that's OK, 
another assistant with different tools will help where you left off. Execute what you can to make progress.
If you or any of the other assistants have the final answer or deliverable,
prefix your response with FINAL_ANSWER so the team knows to stop.
